...
INSERT INTO menu_items (name, description, price, category, image_url) VALUES
  ...
  ('Mango Lassi', 'Refreshing yogurt drink with mango pulp', 70, 'Beverages', '/menu/mango-lassi.jpg?v=2'),
  ...
  ('Masala Chai', 'Traditional Indian spiced tea', 40, 'Beverages', '/menu/masala-chai.jpg?v=2'),
